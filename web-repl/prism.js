...
(Prism.languages.elixir = {
  ...
  string: [
    ...
    { pattern: /("""|''')[\s\S]*?\1/, inside: {} },
    { pattern: /("|')(?:\\[\s\S]|(?!\1)[^\\])*\1/, inside: {} },
  ],
...
(Prism.languages.haxe = Prism.languages.extend("clike", {
  ...
  (Prism.languages.haxe.string.inside.interpolation.inside.rest =
    Prism.util.clone(Prism.languages.haxe)),
...
(Prism.languages.inform7 = {
  ...
  (Prism.languages.inform7.string.inside.substitution.inside.rest =
    Prism.util.clone(Prism.languages.inform7)),
...
Prism.languages.keyman = {
  comment: /\bc\s.*/i,
  function:
    /\[\s*((CTRL|SHIFT|ALT|LCTRL|RCTRL|LALT|RALT|CAPS|NCAPS)\s+)*([TKU]_[a-z0-9_?]+|".+?"|'.+?')\s*\]/i,
  string: /("|')((?!\1).)*\1/,
  bold: [
...
!(function (n) {
  (n.languages.kotlin = n.languages.extend("clike", {
    ...
    n.languages.insertBefore("kotlin", "string", {
      "raw-string": { pattern: /(["'])\1\1[\s\S]*?\1{3}/, alias: "string" },
    }),
...
(Prism.languages.nix = {
  ...
  (Prism.languages.nix.string.inside.interpolation.inside.rest =
    Prism.util.clone(Prism.languages.nix));
...
!(function (e) {
  ...
  var t = ["c", { lang: "c++", alias: "cpp" }, "fortran", "ats", "dsp"],
    a = "%< *-\\*- *{lang}\\d* *-\\*-[\\s\\S]+?%>";
  t.forEach(function (t) {
    var r = t;
    if (
      ("string" != typeof t && ((r = t.alias), (t = t.lang)), e.languages[r])
    ) {
      var i = {};
      (i["inline-lang-" + r] = {
        pattern: RegExp(
        ...
        (i["inline-lang-" + r].inside.rest = e.util.clone(e.languages[r])),
...
!(function (e) {
  ...
  e.languages.insertBefore("crystal", "string", {
    attribute: {
      pattern: /@\[.+?\]/,
      alias: "attr-name",
      inside: { delimiter: { pattern: /^@\[|\]$/, alias: "tag" }, rest: t },
    },
    expansion: [
      {
        pattern: /\{\{.+?\}\}/,
        ...
        (e.code = e.code.replace(t, function (t) {
          return (
            ...
            o
              ...
              : (t === a && (o = !0),
                e.tokenStack.push(t),
                "___SMARTY" + e.tokenStack.length + "___")
          );
        })));
    }),
    e.hooks.add("before-insert", function (e) {
      ...
      if ("smarty" === t.language) {
        for (var a, n = 0; (a = t.tokenStack[n]); n++)
          t.highlightedCode = t.highlightedCode.replace(
            "___SMARTY" + (n + 1) + "___",
            e.highlight(a, t.grammar, "smarty").replace(/\$/g, "$$$$")
          );
...
Prism.languages.tcl = {
  ...
  string: /"(?:[^"\\\r\n]|\\(?:\r\n|[\s\S]))*"/,
  variable: [
    { pattern: /(\$)(?:::)?(?:[a-zA-Z0-9]+::)*[a-zA-Z0-9_]+/, lookbehind: !0 },
    { pattern: /(\$){[^}]+}/, lookbehind: !0 },
    {
...
!(function (e) {
  ...
  (e.languages.textile.phrase.inside.inline.inside.bold.inside = t),
    ...
    (e.languages.textile.phrase.inside.table.inside.footnote = t.footnote),
    (e.languages.textile.phrase.inside.table.inside.acronym = t.acronym),
  ...
  Prism.languages.insertBefore("wiki", "tag", {
    nowiki: {
      ...
      inside: {
        tag: {
          pattern:
            /<(?:nowiki|pre|source)\b[\w\W]*?>|<\/(?:nowiki|pre|source)>/i,
          inside: Prism.languages.markup.tag.inside,
        },
      },
    },
