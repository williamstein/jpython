...
def print_binary_op(self, output):
    if function_ops[self.operator]:
        ...
        output.print('ρσ_operator_add('),  self.left.print(output), output.comma(), self.right.print(output), output.print(')')
    elif self.operator is '-':
        output.print('ρσ_operator_sub('),  self.left.print(output), output.comma(), self.right.print(output), output.print(')')
    elif self.operator is '*':
